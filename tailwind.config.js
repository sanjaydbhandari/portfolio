  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "--color-bg-primary": "#f7f9ff",
        "--color-bg-secondary": "#FCFCFD",
        "--color-bg-translucent": "hsla(0, 0%, 100%, 0.05)",
        "--color-border-primary": "#b9bbc2",
        "--color-border-secondary": "#a5c0f4",
        "--color-border-translucent": " hsla(0, 0%, 100%, 0.05)",
        "--color-text-primary": "#1f1f23",
        "--color-text-secondary": " #1b2f58",
        "--color-link-primary": "#828fff",
        "--color-link-hover": "#4565a1",
        "--color-selection-bg": "#cfe0ff",
        "--color-selection-text": "#263c66",
